...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        # Writing the score.
        self.score_label = Label(text="Score: 0", highlightthickness=0, bg=THEME_COLOR)
        ...
        self.true_button = Button(image=my_image1, highlightthickness=0,
                                  highlightbackground=THEME_COLOR, command=self.true_pressed)
        self.true_button.grid(column=0, row=2)

        # Adding wrong button.
        my_image2 = PhotoImage(file="images/false.png")
        self.false_button = Button(image=my_image2, highlightthickness=0,
